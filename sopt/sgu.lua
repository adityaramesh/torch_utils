...
function SGUOptimizer:log_sgu_nag_info(input, target, cur_lr, loss)
	...
	local theta = math.acos(proj / self.state.temp:norm() *
		self.prev_grad_params:norm())
